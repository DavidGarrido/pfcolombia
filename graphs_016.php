...
switch($meta1){
    ...
    case 7:
        ...
        $datos[] = "['Número de discípulos que pasan a ECC', ".intval($dto_1_discipulos).", '#F39C12' ]";
        break;
    default:
        $datos[] = "['0', 0, '#F39C12' ]";
        break;
...
switch($meta2){
    ...
    case 6:
        ...
        break;
    case 7:
        $datos[] = "['".obtenerPorcentaje($dto_1_discipulos, $meta1_valor)."% Número de discípulos que pasan a ECC', ".intval($dto_1_discipulos).", '#2E86C1' ]";
        break;
    default:
        $datos[] = "['0', 0, '#2E86C1' ]";
        break;
...
<div class="container">
    <form action="index.php" method="get" name="form1" class="form-horizontal">
        <input type="hidden" name="doc" value="graphs_016" />
        <div class="row">
            ...
            */
            ...
            <div class="col-sm-2">
                ...
                <select name="meta1" id="meta1" class="form-control">
                    ...
                    <option value="7" <?php if($meta1 == 7){ ?>selected<?php } ?>>Número de discípulos que pasan a ECC</option>    
                </select>
            </div>
            <div class="col-sm-2">
                ...
                <select name="meta2" id="meta2" class="form-control">
                    ...
                    <option value="7" <?php if($meta2 == 7){ ?>selected<?php } ?>>Número de discípulos que pasan a ECC</option> 
                </select>
            </div>
                            ...
                            <p><?php 
                                switch($meta1){
                                    ...
                                    case 6:
                                        ...
                                        break;
                                    case 7:
                                        echo "Número de discípulos que pasan a ECC";
                                        break;
                                    default:
                                        echo "Seleccione";
                                        break;
