...
<div class="container">
    <form action="index.php" method="get" name="form1" class="form-horizontal">
        <input type="hidden" name="doc" value="grafica-consolidado-instituto-biblico" />
        <div class="row">
            <h3 class="alert alert-info text-center">GRÁFICA DE CONSOLIDADO INSTITUTO BIBLICO</h3>
        </div>
        <div class="cont-tit">
            <div class="hr"><hr></div>
            <div class="tit-cen">
