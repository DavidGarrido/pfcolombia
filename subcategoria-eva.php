...
LEFT JOIN categorias AS CA ON CA.id = C.idSec";
    ...
    if($PSN1->num_rows() > 0)
    {
        ...
        <div class="form-group">
            <center><input type="button" onClick="window.location.href='index.php?doc=reportar_buscar-eva'" name="previous" class="previous btn btn-danger" value="Cerrar" /> <br />
        </div>
        <?php
        exit;
    }
        ...
        <h3 class="alert alert-info text-center"><?php
            ...
            <div class="cont-btn cont-flex fl-sbet">
                <div class="item-btn">
                    <?php
                    if ($antId != 0) {?>
                    <a href="index.php?doc=subcategoria-eva&id=<?=$antId ?>" name="previous" class="previous btn btn-info">Anterior reporte <?=$antId ?></a>
                    <?php } ?>
                </div>
                <div class="item-btn">
                    <a href="index.php?doc=reportar_buscar-eva" name="previous" class="btn btn-warning">Todos los reportes</a>
                </div>
                <div class="item-btn">
                    <?php
                    if ($sigId != 0) {?>
                    <a href="index.php?doc=subcategoria-eva&id=<?=$sigId ?>" name="previous" class="previous btn btn-info">Siguiente reporte <?=$sigId ?></a>
                    <?php } ?>
                </div>
            </div>
    <?php //} ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                <div class="col-sm-2">
                    <input type="text" name="total" id="total" class="form-control" value="<?= $asistencia_total; ?>" readonly>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                <input name="asistencia_hom" type="number" id="asistencia_hom" value="<?=$asistencia_hom; ?>" class="form-control" onChange="sumar()"  />
            </div>
            <div class="col-sm-3">
                <strong>Número de grupos extramuros atendidos:</strong>
                <input name="asistencia_muj" type="number" id="asistencia_muj" value="<?=$asistencia_muj; ?>" class="form-control"  onChange="sumar()" />
            </div>
            <div class="col-sm-3"></div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                <input name="asistencia_jov" type="number" id="asistencia_jov" value="<?=$asistencia_jov; ?>" class="form-control" onChange="sumar()"  />
            </div>
            <div class="col-sm-4">
                <strong>Total de discípulos (LPP) que pasan a ECC en el mes:</strong>
                <input name="asistencia_nin" type="number" id="asistencia_nin" value="<?=$asistencia_nin; ?>" class="form-control" onChange="sumar()"  />
            </div>
            <div class="col-sm-2"></div>
        </div> 
            <div class="cont-tit">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input name="bautizados" type="number" id="bautizados" value="<?=$bautizados; ?>" class="form-control"  />
                </div>
                <div class="col-sm-3">
                    <strong>Número de voluntarios internos activos:</strong>
                    <input name="discipulado" type="number" id="discipulado" value="<?=$discipulado; ?>" class="form-control"  />
                </div>
                <div class="col-sm-3">
                    <strong>Número de voluntarios externos activos:</strong>
                    <input name="desiciones" type="number" id="desiciones" value="<?=$desiciones; ?>" class="form-control"  />
                </div>
                <div class="col-sm-3">
                    <strong>Número de pospenados que está acompañando:</strong>
                <input name="preparandose" type="number" id="preparandose" value="<?=$preparandose; ?>" class="form-control"  /></div>
            </div>        
...
if($idReporteActual > 0){
    ...
    <div class="container">
        ...
        <div class="row">
            <h2 class="alert alert-success text-center"><a href="index.php?doc=subcategoria-eva&opc=2&id=<?=$ultimoId; ?>" class="h2">Se ha <?php
            if($idReporteActual == 0){
                echo "creado";
            }
            else{
