...
<tbody>
		...
		if($inactivo == 1)
		{
            ...
            <tr height="25px"><td colspan="4"><center><input type="button" name="button" onclick="inactivar(0)" value="Activar" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"></td></tr><?php
		}
		else
		{
			?><tr height="25px"><td colspan="4"><center>ESTE CLIENTE ESTA ACTIVO</td></tr>
            <tr height="25px"><td colspan="4"><center><input type="button" name="button" onclick="inactivar(1)" value="Inactivar" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"></td></tr><?php
		}
		?>
    </tr>
	...
	<tr>
		...
		<td><select name="cuota">
			<option value="1" <?php if($cuota == "1"){ ?>selected="selected"<?php } ?>>Mes</option>
			<option value="2" <?php if($cuota == "2"){ ?>selected="selected"<?php } ?>>Anho</option>
			<option value="3" <?php if($cuota == "3"){ ?>selected="selected"<?php } ?>>Unica</option>
		</select></td>
    ...
    <tr>
		...
		<td><select name="titulo_valor">
			<option value="1" <?php if($titulo_valor == "1"){ ?>selected="selected"<?php } ?>>Cheque</option>
			<option value="2" <?php if($titulo_valor == "2"){ ?>selected="selected"<?php } ?>>Cheque - Letra</option>
			<option value="3" <?php if($titulo_valor == "3"){ ?>selected="selected"<?php } ?>>Cheque - Pagare</option>
            <option value="4" <?php if($titulo_valor == "4"){ ?>selected="selected"<?php } ?>>Cheque - Factura</option>
            <option value="5" <?php if($titulo_valor == "5"){ ?>selected="selected"<?php } ?>>Cheque - Letra - Pagare</option>
            <option value="6" <?php if($titulo_valor == "6"){ ?>selected="selected"<?php } ?>>Cheque - Letra - Factura</option>
            <option value="7" <?php if($titulo_valor == "7"){ ?>selected="selected"<?php } ?>>Cheque - Pagare - Factura</option>
    </select></td>
...
<!--	<tr>
	...
	<tr>
		...
		<td><input name="cuporotativo" type="checkbox" id="cuporotativo" value="1" <?php
        if($cuporotativo == 1)
		{
			?>checked="checked"<?php
		}
	...
	<tr>
		...
		{
			?><img src="images/clientes/<?=$varMiId;?>.jpg" align="middle" width="200" style="border-color:#0000FF" border="1"><?php
		}
		else
		{
			echo "&nbsp;";
...
?>
		...
		<td><input name="tipoTarifa" type="checkbox" id="tipoTarifa" value="1" <?php
        ...
        <tr>
            ...
            */
            ...
            if($numero > 0)
            {
                ...
                {
                    ?><option value="<?=$PSN_Edu->f('id'); ?>" <?php
                    if($idEducativo == $PSN_Edu->f('id'))
                    {
                            ?>selected="selected"<?php
                    }
                    ?>><?=$PSN_Edu->f('nombre')." (".$PSN_Edu->f('nombre').")"; ?></option><?php
                }
            }
            ?>
            </select></td>
        ...
        <tr>
            ...
            */
            ...
            if($numero > 0)
            {
                ...
                {
                    ?><option value="<?=$PSN_Real->f('id'); ?>" <?php
                    if($idReal == $PSN_Real->f('id'))
                    {
                            ?>selected="selected"<?php
                    }
                    ?>><?=$PSN_Real->f('nombre')." (".$PSN_Real->f('nombre').")"; ?></option><?php
                }
            }
            ?>
            </select></td>
...
<center><input type="button" name="button" onclick="generarForm()" value="Actualizar Cliente" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"> <input type="button" name="button" onclick="regresar()" value="Cancelar" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"> <input type="button" name="button" onclick="imprimirOperacion()" value="Imprimir" style="background-color:#FFFFFF;border-color:#0000FF;color:#006600;font-weight:bold"></center>
	...
	function init(){
		...
		if($varExitoUSU == 1)
		{
			?>alert("Se ha actualizado correctamente el CLIENTE.");<?php
		}
		?>
	}
