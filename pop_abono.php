...
?><div class="container">
<form method="post" enctype="multipart/form-data" name="form1" id="form1" action="pop_up.php?doc=pop_abono&id=<?=$varMiId; ?>" class="form-horizontal">
	
    <div class="form-group">
        <h3 class="text-center well">.INSERTAR ABONO.</h3>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="valor">Valor del abono</label>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="archivo">Archivo anexo</label>
...
function generarForm(){
	if(confirm("Esta accion insertara un abono a la cotizacion seleccionada, esta seguro que desea continuar?"))
	{
