...
*/
$nombreGrafica ="IGLESIAS EN CASA";
$datos = array();
//
//
$sql = "SELECT
...
//
//$sql.=" WHERE sat_reportes.generacionNumero != 0 ".$sqlFiltro." GROUP BY sat_reportes.generacionNumero";
...
<input type="hidden" name="doc" value="graphs_006" />

<div class="form-group">
    <center><h2 class="text-center well col-sm-12">.FILTROS DE BUSQUEDA - IGLESIAS EN CASA.</h2></center>
</div>
        <div class="form-group">
