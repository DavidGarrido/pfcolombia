...
LEFT JOIN categorias AS CA ON CA.id = C.idSec";
    ...
    <form name="form" id="form" method="get" class="form-horizontal">
        <input type="hidden" name="doc" value="consultar-sub-programa-proyecto-felipe" />
        <div>
            <h3 class="alert alert-info text-center">CONSULTA DE PROYECTO FELIPE</h3>
        </div>
        <div class="cont-tit">
            <div class="hr"><hr></div>
            <div class="tit-cen">
            ...
            <table border="0" cellspacing="0" cellpadding="2"  align="center" class="table table-striped" style="font-size:12px">
                <thead>
                    <tr> 
                        ...
                        <th width="15%">Prisión</th>
                        <th width="10%">Miembro de la prisión</th>
                        <th width="10%" title="Prisioneros invitados">Prisioneros invitados</th>
                        <th width="10%" title="Prisioneros inscritos">Prisioneros inscritos</th>
                        <th width="10%"  title="Prisioneros que iniciaron">Prisioneros que iniciaron</th>
                        <th width="5%"  title="Total de cursos">Total de cursos</th>
                        <th width="5%" title="Total de graduados">Total de graduados</th>
                        <th width="10%" title="Total Voluntarios internos">Voluntarios internos</th>
                        <th width="10%" title="Total Voluntarios externos">Voluntarios externos</th>
                ...
                <tbody>
                    ...
                    if($total_registros > 0){
                        ...
                        while($PSN1->next_record()){
                            ...
                            ?><tr class='clickable-row' data-href='index.php?doc=gestionar-sub-programa-proyecto-felipe&id=<?=$id; ?>' >
                                <!--<td><a href="index.php?doc=gestionar-sub-programa-proyecto-felipe&id=<?=$id; ?>"><?=str_pad($id, 6, "0", STR_PAD_LEFT); ?></a></td>//-->
                                ...
                                <td><?=$prision;?></td>
                                <td><a href="index.php?doc=gestionar-sub-programa-proyecto-felipe&id=<?=$id; ?>"><?=$nombreUsuario; ?></a></td>
