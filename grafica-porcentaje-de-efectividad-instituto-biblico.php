...
*/
$nombreGrafica ="PORCENTAJES DE EFECTIVIDAD DE INSTITUTO BIBLICO";
...
$sql.=" WHERE 1 AND sat_reportes.rep_tip = 317 ".$sqlFiltro." GROUP BY RU.reub_id ORDER BY sat_reportes.fechaReporte";
$PSN4->query($sql);
//echo $sql;
$num=$PSN4->num_rows();
if($num > 0){
    while($PSN4->next_record()){
        $total_prisiones += intval($PSN4->f('total_poblacion'));
    }
}*/
...
switch($meta1){
    ...
    case 2:
        ...
        $datos[] = "['Número de prisioneros invitados al diplomado', ".intval($total_poblacion).", '#F39C12' ]";
        break;
    case 3:
        $meta1_valor = intval($dto_1_prns_invitados);
        $datos[] = "['Número de prisioneros inscritos en el diplomado', ".intval($dto_1_prns_invitados).", '#F39C12' ]";
        break;
        break;
    case 4:
        $meta1_valor = intval($dto_1_prns_iniciaron);
        $datos[] = "['Número de prisioneros que iniciaron el diplomado', ".intval($dto_1_prns_iniciaron).", '#F39C12' ]";
        break;
    case 5:
        $meta1_valor = intval($dto_1_prns_graduados);
        $datos[] = "['Número de prisioneros graduados', ".intval($dto_1_prns_graduados).", '#F39C12' ]";
        break;
    case 6:
...
switch($meta2){
    case 1:
        $datos[] = "['".obtenerPorcentaje($total_prisiones, $meta1_valor)."% Número de prisiones', ".intval($total_poblacion).", '#2E86C1' ]";
        break;
    case 2:
        $datos[] = "['".obtenerPorcentaje($total_poblacion, $meta1_valor)."% Número de prisioneros invitados al diplomado', ".intval($total_poblacion).", '#2E86C1' ]";
        break;
    case 3:
        $datos[] = "['".obtenerPorcentaje($dto_1_prns_invitados, $meta1_valor)."% Número de prisioneros inscritos en el diplomado', ".intval($dto_1_prns_invitados).", '#2E86C1' ]";
        break;
    case 4:
        $datos[] = "['".obtenerPorcentaje($dto_1_prns_iniciaron, $meta1_valor)."% Número de prisioneros que iniciaron el diplomado', ".intval($dto_1_prns_iniciaron).", '#2E86C1' ]";
        break;
    case 5:
        $datos[] = "['".obtenerPorcentaje($dto_1_prns_graduados, $meta1_valor)."% Número de prisioneros graduados', ".intval($dto_1_prns_graduados).", '#2E86C1' ]";
        break;
    case 6:
...
<div class="container">
    <form action="index.php" method="get" name="form1" class="form-horizontal">
        <input type="hidden" name="doc" value="grafica-porcentaje-de-efectividad-instituto-biblico" />
        <div class="row">
            <h3 class="alert alert-info text-center">GRÁFICA DE PORCENTAJES DE EFECTIVIDAD DE INSTITUTO BIBLICO</h3>
        </div>
        <div class="cont-tit">
            <div class="hr"><hr></div>
            <div class="tit-cen">
            ...
            */
            ...
            <div class="col-sm-2">
                ...
                <select name="meta1" id="meta1" class="form-control">
                    ...
                    <option value="2" <?php if($meta1 == 2){ ?>selected<?php } ?>>Número de prisioneros invitados al diplomado</option>
                    <option value="3" <?php if($meta1 == 3){ ?>selected<?php } ?>>Número de prisioneros inscritos en el diplomado</option>
                    <option value="4" <?php if($meta1 == 4){ ?>selected<?php } ?>>Número de prisioneros que iniciaron el diplomado</option>
                    <option value="5" <?php if($meta1 == 5){ ?>selected<?php } ?>>Número de prisioneros graduados</option>    
                </select>
            </div>
            <div class="col-sm-2">
                ...
                <select name="meta2" id="meta2" class="form-control">
                    ...
                    <option value="2" <?php if($meta2 == 2){ ?>selected<?php } ?>>Número de prisioneros invitados al diplomado</option>
                    <option value="3" <?php if($meta2 == 3){ ?>selected<?php } ?>>Número de prisioneros inscritos en el diplomado</option>
                    <option value="4" <?php if($meta2 == 4){ ?>selected<?php } ?>>Número de prisioneros que iniciaron el diplomado</option>
                    <option value="5" <?php if($meta2 == 5){ ?>selected<?php } ?>>Número de prisioneros graduados</option>
                </select>
            </div>
                            ...
                            <p><?php 
                                switch($meta1){
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        echo "Número de prisioneros invitados al diplomado";
                                        break;
                                    case 3:
                                        echo "Número de prisioneros inscritos en el diplomado";
                                        break;
                                    case 4:
                                        echo "Número de prisioneros que iniciaron el diplomado";
                                        break;
                                    case 5:
                                        echo "Número de prisioneros graduados";
                                        break;
                                    default:
                                        echo "Seleccione";
                                        break;
                    ...
                    <div class="item-con">
                        <div class="item-text">
                            ...
                            <p><?php 
                                switch($meta2){
                                    case 1:
                                        echo "Número de prisiones en las que están";
                                        break;
                                    case 2:
                                        echo "Número de prisioneros invitados al diplomado";
                                        break;
