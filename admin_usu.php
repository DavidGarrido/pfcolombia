...
<!-- 	<tr>
	...
	<tr>
		...
		else
		{
			...
			?><td><input type="hidden" name="idSucursal" id="idSucursal" value="<?=$_SESSION["idSucursal"]; ?>" /><?=$nombreSucursal ; ?></td><?php
		}
		?>
...
function init(){
	...
	if($varExitoUSU == 1)
	{
		...
		window.location.href = "index.php?doc=admin_usu2&id=<?=$ultimoId;?>";<?php
	}
	?>
}
