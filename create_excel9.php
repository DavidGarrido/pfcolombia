...
WHERE t.`adj_fec` >= '2024-01-01' AND t.`adj_fec` <= CURDATE()" or die(mysqli_error($conn));;
    ...
    // Si no está autenticado y se intenta exportar, redirige al usuario a la página de inicio
