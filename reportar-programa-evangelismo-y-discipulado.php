...
if($preguntarGeneracion == 1){
    ...
    <fieldset>
        ...
        <div class="cont-flex fl-cent">
            <a href="?doc=gestionar-sub-programa-evangelistas<?php echo($resul>0)?"&id=".$PSN1->f('registro'):""; ?>" class="btn-mar btn btn-primary ">EVANGELISTAS<br><span class="btn-desc">Reporte<?php echo($resul>0)?": ".$PSN1->f('registro'):""; ?></span></a>
            <a href="?doc=gestionar-sub-programa-lpp" class="btn-mar btn btn-danger">LA PEREGRINACIÓN<br><span class="btn-desc">DEL PRISIONERO</span></a>
            <a href="?doc=gestionar-sub-programa-ecc" class="btn-mar btn btn-success">ECC<br><span class="btn-desc">(CADA COMUNIDAD PARA CRISTO "SATURA")</span></a>
            <a href="?doc=gestionar-sub-programa-proyecto-felipe" class="btn-mar btn btn-info">PROYECTO<br><span class="btn-desc">FELIPE</span></a>
            <a href="?doc=gestionar-sub-programa-instituto-biblico" class="btn-mar btn btn-warning">INSTITUTO<br><span class="btn-desc">BIBLICO</span></a>                      
        </div><br><br>        
