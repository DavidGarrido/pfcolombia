...
function init(){
	...
	if($varExitoDEL == 1)
	{
		...
		window.location.href = "index.php?doc=admin_buscarc";<?php
	}
	?>
}
...
if($numero > 0)
{
	...
	while($PSN1->next_record())
	{
		...
		{
			?><img src="images/clientes/<?=$id;?>.jpg" align="middle" width="60px" height="25px" style="border-color:#0000FF"><?php
		}
		else
		{
			echo "&nbsp;";
		...
		if($_SESSION["superusuario"] == 1)
		{
			?><td><a href="index.php?doc=admin_usu2&id=<?=$id; ?>"><?=$nombreSucursal; ?></a></td><?php
		}
		?>
